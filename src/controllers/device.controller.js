...
exports.createDevice=async(req,res)=>{
    const DeviceData=await Device.findOne({serial_number:req.body.serial_number})
    if(DeviceData) return res.status(INVELID_JSON).json(successResponseHandler({message:"Device already exist"}))
    else {
        let finalData={
